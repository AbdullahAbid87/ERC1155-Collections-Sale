...
contract Collections is ERC1155,Ownable {
    ...
    uint256[] public cost = [0.01 ether,0.02 ether,0.03 ether,0.04 ether,0.05 ether,0.06 ether,0.07 ether,0.08 ether,0.09 ether,0.1 ether];
    ...
    function mintFreeNFT() public payable  {
        ...
        require(freeNftAvailed<=freeNftsupply,"Free NFT Supply has been fulfilled");
